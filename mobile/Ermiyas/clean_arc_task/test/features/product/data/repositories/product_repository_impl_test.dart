...
void main() {
  ...
  group('Add Product', () {
    final tProductModel = ProductModel(
      '1', // This id will now come from the database
      name: 'Test Product',
    ...
    final Product tProduct = ProductModel(
      '', // Pass an empty id since it will be generated by the database
      name: 'Test Product',
      category: 'Test Category',
      price: 10.0,
      description: 'This is a test product',
    ...
    runTestsOnline(() {
      test(
        'should return remote data with generated id when the call to remote data source is successful',
        () async {
          // arrange
          when(mockProductRemoteDataSource.addProduct(any))
              .thenAnswer((_) async => tProductModel);
